...
/**
 * 该类是一个使用{@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.ReferenceType#SOFT soft} 或 {@linkplain cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.ReferenceType#WEAK weak}
 * （引用）keys和values的{@link java.util.concurrent.ConcurrentHashMap}
 *
 * <p>该类可用于替代{@code Collections.synchronizedMap(new WeakHashMap<K, Reference<V>>())} 的
 * 使用场景，以便于在同步操作时获得更好的性能。 该实现同 {@link java.util.concurrent.ConcurrentHashMap}一样，支持{@code null}的keys和values.
 *
 * <p><b>注意:</b> 使用references意味着不需要保证放入map中的items一直有效。gc可能在任何时候找到这些references，以至于
 * entries会被默默的回收掉。
 *
 * <p>默认使用{@linkplain java.lang.ref.SoftReference soft entry references}
 *
 * @author Phillip Webb
 * @since 3.2
 */
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
	...
	/**
	 * Factory method that returns the {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.ReferenceManager}.
	 * This method will be called once for each {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Segment}.
	...
	/**
	 * Return a {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Reference} to the {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Entry} for the specified {@code key},
	...
	/**
	 * A reference to an {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Entry} contained in the map. Implementations are usually
	...
	/**
	 * A task that can be {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Segment#doTask run} against a {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Segment}.
	 */
	private abstract class Task<T> {
		 ...
		 * @see #execute(cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Reference, cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Entry)
		 */
		...
		/**
		 * Convenience method that can be used for tasks that do not need access to {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Entries}.
		 * @param reference the found reference or {@code null}
		 * @param entry the found entry or {@code null}
		 * @return the result of the task
		 * @see #execute(cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Reference, cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Entry, cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Entries)
		 */
	...
	/**
	 * Allows a task access to {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Segment} entries.
	 */
	...
	/**
	 * Strategy class used to manage {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Reference}s. This class can be overridden if
	...
	protected class ReferenceManager {
		...
		/**
		 * Factory method used to create a new {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Reference}.
		 * @param entry the entry contained in the reference
		 * @param hash the hash
		 * @param next the next reference in the chain or {@code null}
		 * @return a new {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Reference}
		 */
	...
	/**
	 * Internal {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Reference} implementation for {@link java.lang.ref.SoftReference}s.
	 */
	...
	/**
	 * Internal {@link cn.evun.sweet.framework.common.datastructure.ConcurrentReferenceHashMap.Reference} implementation for {@link java.lang.ref.WeakReference}s.
	 */
